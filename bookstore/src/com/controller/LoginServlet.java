...
public class LoginServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        session.setAttribute("credit", userValidate);
        if(!userValidate.equals("Invalid user credentials")) //If function returns success string then user will be rooted to Home page
         {
             ...
             request.getRequestDispatcher("/BookCatalog.jsp").forward(request, response);//RequestDispatcher is used to send the control to the invoked page.
         }
         else
         {
